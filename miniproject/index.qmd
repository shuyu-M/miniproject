...
The gap between best and worst performers is dramatic. <span class="highlight">Alaska Airlines</span> experienced a maximum delay of just 8.6 hours, while <span class="highlight">American Airlines</span> had flights delayed over 28 hours—more than an entire day.

This doesn't necessarily mean American is "worse"—larger airlines with more flights and routes face more opportunities for extreme delays. However, it does raise questions about operational recovery procedures and how airlines handle severe disruptions.
...
Interestingly, some airlines also depart significantly early—up to 46 minutes ahead of schedule.
...
print(f"🏆 'Winner' of Worst Average Delay:")
...
<span class="highlight">Houghton County Memorial Airport (CMX)</span> in Michigan's Upper Peninsula averages 70 minutes of departure delays—over an hour per flight. 
...
Delays aren't uniform—each airline has specific airports where operations break down:
...
::: {.key-finding}
### <span class="metric">13,012</span>
**flights were canceled in May 2019—representing 2% of all scheduled flights.**
...
- **DFW (Dallas/Fort Worth)**: 1,187 weather cancellations—likely due to spring storms
- **IAH (Houston)**: 334 weather cancellations—Gulf Coast weather systems
- **CLT (Charlotte)**: 314 weather cancellations—Southeastern thunderstorms
...
The data reveals a clear weekly breathing pattern in air travel. Every Saturday and Sunday show significant drops, with flight volumes falling to 15,000-17,000 compared to over 21,000 on weekdays. Memorial Day weekend (May 25-27) shows the deepest sustained drop, with Friday's volume falling by 23%. Despite these fluctuations, mid-week peaks remain remarkably stable around 21,000-22,000 flights.

The 3-day rolling average (red dashed line) smooths out day-to-day noise and reveals a stable baseline of about 20,000-21,000 flights during normal weeks. Holiday weeks disrupt this baseline predictably, but recovery to normal levels happens quickly—usually within 2-3 days.

These patterns create clear operational opportunities. Airlines can confidently reduce capacity on weekends, while crew scheduling should account for the 30% variation between peak and trough days. Airport resources like gates, ground staff, and security can be flexed based on these predictable patterns. Maintenance windows naturally fall on low-volume weekends, making the weekly cycle work to everyone's advantage.
:::
